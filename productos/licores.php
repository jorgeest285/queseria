...
<head>
    ...
    <title>Queseria el Veracruzano | Licores</title>
        ...
        <div class="main">
            ...
            <main class="content px-2 py-2">
                <div class="container-fluid mx-2">
                    <div>
                        <h4 class="fw-semibold py-2">Licores</h6>
                    </div>
                    ...
                    <div class="py-2">
                        <table class="table">
                            ...
                            <tbody class="table-group-divider">
                                <?php
                                $stmt = $pdo->query("SELECT * FROM licores"); // Ejecutar la consulta
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-warning btn-sm" onclick="cargarDatosProducto(<?php echo $row['id']; ?>, 'licores');">Editar</button>
                                                    <form onsubmit="event.preventDefault(); eliminarProducto(<?php echo $row['id']; ?>, 'licores');">
