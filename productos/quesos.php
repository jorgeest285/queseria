...
<head>
    ...
    <title>Queseria el Veracruzano | Quesos</title>
        ...
        <div class="main">
            ...
            <main class="content px-2 py-2">
                <div class="container-fluid mx-2">
                    ...
                    <div>
                        <h4 class="fw-semibold py-2">Quesos</h6>
                    </div>
                    ...
                    <div class="py-2">
                        <table class="table">
                            ...
                            <tbody class="table-group-divider">
                                <?php
                                $stmt = $pdo->query("SELECT * FROM quesos"); // Ejecutar la consulta
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <!-- Boton de editar -->
                                                    <button type="button" class="btn btn-warning btn-sm" onclick="cargarDatosProducto(<?php echo $row['id']; ?>, 'quesos');">Editar</button>
                                                    <!-- Formulario de eliminar -->
                                                    <form onsubmit="event.preventDefault(); eliminarProducto(<?php echo $row['id']; ?>, 'quesos');">
